...
public class MainActivity extends AppCompatActivity
{
    ...
    private void initBMB()
    {
        ...
        for (int i = 0; i < mBoomMenuButton.getPiecePlaceEnum().pieceNumber(); i++)
        {
            TextOutsideCircleButton.Builder builder = new TextOutsideCircleButton.Builder()
                    .listener(index -> handleBMBItemsClick(index))
                    .normalImageRes(Constants.BMB_MENU_ITEM_ICON_IDS[i])
                    .normalText(Constants.BMB_MENU_ITEM_TITLES[i])
    ...
    private void initEditText()
    {
        ...
        mExpressionInputEditText.addTextChangedListener(new TextWatcher()
        {
            ...
            public void afterTextChanged(Editable s)
            {
                ...
                //mExpressionInputEditText.setText(s);
    ...
    private void hideSoftKeyboardWithCursor()
    {
        ...
        {
            // 4.0以下采用此方法
            mExpressionInputEditText.setInputType(InputType.TYPE_NULL);
        }
        else
        {
    ...
    private void initNumericMenu()
    {
        ...
        GridViewAdapter gridViewAdapter = new GridViewAdapter(this,
                Arrays.asList(Constants.NUMERIC_MENU_ITEM_TITLES), null, R.layout.cell_numeric);
    ...
    private void initPageViews()
    {
        ...
        GridViewAdapter constantsGridViewAdapter = new GridViewAdapter(this,
                Arrays.asList(Constants.CONSTANT_SYMBOLS), Arrays.asList(Constants.CONSTANT_DESCRIPTIONS),
                R.layout.cell_constant);

        GridViewAdapter functionsGridViewAdapter = new GridViewAdapter(this,
                Arrays.asList(Constants.FUNCTION_SYMBOLS), Arrays.asList(Constants.FUNCTION_DESCRIPTIONS),
    ...
    private void initTabPages()
    {
        ...
        mTabBar.addTab(mTabBar.newTab().setText("常数"));
        mTabBar.addTab(mTabBar.newTab().setText("函数"));
    ...
    @OnClick({R.id.tv_clear_all, R.id.tv_delete, R.id.tv_copy, R.id.iv_drawer_left_arrow
            , R.id.tv_add, R.id.tv_sub, R.id.tv_mul, R.id.tv_div, R.id.tv_percent, R.id.tv_power
            , R.id.tv_degree, R.id.tv_factorial, R.id.tv_square_root, R.id.tv_infinity, R.id.tv_imaginary_num_unit
            , R.id.tv_double_brace, R.id.tv_comma, R.id.tv_x_parameter})
    ...
    private void calcExpresssion(boolean isSave)
    {
        ...
        String inputString = mExpressionInputEditText.getText().toString();

        StringBuilder expressionStringBuilder = new StringBuilder();

        for(int i = 0; i <inputString.length(); i++)
        {
            String inputChar = String.valueOf(inputString.charAt(i));
            ...
            expressionStringBuilder.append(inputChar);
        }
